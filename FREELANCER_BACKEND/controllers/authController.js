...
//This function clears the authentication token (JWT cookie) and logs out the user.
export const logout =async (req,res)=>{
    res.clearCookie("accessToken",{
        sameSite:"none", // Allow cross-site requests (for frontend & backend on different domains)
